...
#+HTML_HEAD_EXTRA: <link rel="stylesheet" href="styles/tomorrow.css">
#+HTML_HEAD_EXTRA: <script src="highlight.pack.js"></script>
#+HTML_HEAD_EXTRA: <script src="svg.js"></script>
...
<div class="right-menu">
  <button type="button" id="disqus-toggle">Toggle comments</button>
  <a target="_blank" id="cv-link" href="cv_en.pdf"><button type="button" id="cv-pdf">CV - pdf</button></a>
</div>
...
[[https://github.com/antonaut/][@antonaut]]). I am 27 years old and live in Oslo, Norway. I am
originally from Sweden, but moved here pretty recently. Currently I am
working as a software engineer at Conax and finishing my master's
thesis.
...
#+begin_export html
<iframe src="https://player.vimeo.com/video/148290340" width="640" height="360" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
<p><a href="https://vimeo.com/148290340">Padawan 101 - project video</a> from <a href="https://vimeo.com/user14547966">Viktor Leandersson</a> on <a href="https://vimeo.com">Vimeo</a>.</p>
#+end_export
