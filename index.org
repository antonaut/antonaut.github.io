...
#+HTML_HEAD_EXTRA: <link rel="stylesheet" href="//cdnjs.cloudflare.com/ajax/libs/highlight.js/9.3.0/styles/tomorrow.min.css">
#+HTML_HEAD_EXTRA: <script src="//cdnjs.cloudflare.com/ajax/libs/highlight.js/9.3.0/highlight.min.js"></script>
...
* Spiral matrix in Clojure, Apr 15                     :code:problem:solving:
